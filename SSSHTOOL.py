...
StartConfig = platform()[0], platform()[1],  platform()[2], platform()[3], platform()[4], platform()[5], platform()[6]
if StartConfig == ('W', 'i', 'n', 'd', 'o', 'w', 's'):
    delet = 'cls'
    dr = '\\'
else:
    delet = 'clear'
    dr = '/'
print(Fore.RED + "color system test")
os.system(delet)
print(Back.BLUE + "Slava   ")
print(Back.YELLOW + "Ukraine!")
time.sleep(3.0)
os.system(delet)
print(Back.BLACK + "color system test")
os.system(delet)
print("By ShadowShiff and Sergeyka228")
time.sleep(2.0)
os.system(delet)
while True:
	print("""
